...
import org.jjh.mallapi.util.CustomJWTException;
...
public class APIRefreshController {
    ...
    private boolean checkTime(Integer exp) {
        ...
        //JWT exp를 날짜로 변환
        java.util.Date expDate = new java.util.Date((long) exp * (1000)); //현재 시간과의 차이 계산 - 밀리세컨즈

        long gap = expDate.getTime() - System.currentTimeMillis(); //분단위 계산
